...
// HERO SLIDER
var heroSlides=[
  {img:'img/work1.jpg',badge:'<b>15+ лет</b> делаем ремонт в Волгограде и Волжском'},
  {img:'img/work4.jpg',badge:'<b>Под ключ</b> — от черновой до чистовой отделки'},
  {img:'img/work2.jpg',badge:'<b>Дизайнерский</b> ремонт с подбором материалов'},
  {img:'img/work3.jpg',badge:'<b>Офисы и магазины</b> — ремонт без остановки бизнеса'}
];
